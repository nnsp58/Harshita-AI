...
Return the complete HTML code only. No explanations.`;
    ...
    try {
      ...
      // Inject Harshita AI branding footer
...
Return ONLY the code, no explanations.`;
  ...
  /**
   * Inject Harshita AI branding into generated pages
   */
  ...
  _generateFromTemplate(prompt, pageType, data = {}) {
    ...
    const title = prompt || 'Harshita AI Generated Page';
...
<body>
  <div class="header">
    <h1>🤖 ${title}</h1>
    <p>Harshita AI AI Platform द्वारा स्वचालित रूप से जनरेट किया गया पेज</p>
  </div>
  ...
  <div class="container">
    ...
    <div class="card" style="margin-top:32px;">
      ...
      <p style="line-height:1.8;color:#555;">
        This page was generated by the <strong>UIBuilderAgent</strong> of the Harshita AI AI Platform.
