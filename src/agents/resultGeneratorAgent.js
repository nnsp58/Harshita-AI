...
<head>
  <meta charset="UTF-8">
  <title>Harshita AI Result — ${jobId}</title>
  <style>
...
<body>
  <div class="header">
    <h1>🤖 Harshita AI AI — Submission Report</h1>
  ...
  <div class="footer">Generated by Harshita AI AI Platform &copy; ${new Date().getFullYear()} &mdash; ₹0 cost</div>
</body>
</html>`;
