...
const noticeTypes = [
  { id: 'cheque_bounce', name: 'Cheque Bounce / चेक बाउंस', icon: '💳', desc: 'Section 138 NI Act notice for dishonoured cheque' },
  { id: 'eviction', name: 'Eviction Notice / बेदखली नोटिस', icon: '🏠', desc: 'Tenant eviction notice' },
  { id: 'money_recovery', name: 'Money Recovery / राशी वसूली', icon: '💰', desc: 'Recover money lent to someone' },
  { id: 'defamation', name: 'Defamation / मानहानि', icon: '⚠️', desc: 'Stop defamation and claim damages' },
  { id: 'property_dispute', name: 'Property Dispute / सम्पत्ति विवाद', icon: '🏡', desc: 'Property ownership or possession dispute' },
  { id: 'recovery_of_dues', name: 'Recovery of Dues / बकाया वसूली', icon: '📋', desc: 'Recover pending dues' },
  { id: 'breach_contract', name: 'Breach of Contract / अनुबंध भंग', nameHi: 'अनुबंध भंग', icon: '📄', desc: 'Compensate for contract breach' },
  { id: 'consumer_complaint', name: 'Consumer Complaint / उपभोक्ता शिकायत', icon: '🛒', desc: 'File consumer court complaint' },
]
            ...
            <>
              ...
              <div className="bg-white/5 border border-orange-500/30 rounded-xl p-4">
                ...
                <textarea value={naturalInput} onChange={e => setNaturalInput(e.target.value)}
                  rows={4}
                  placeholder={'Example: "Mohan Kumar se maine ₹50,000 udhaar diye the, wo 6 mahine se nahi de raha hai, cheque bounce ho gaya hai notice bhejo"'}
