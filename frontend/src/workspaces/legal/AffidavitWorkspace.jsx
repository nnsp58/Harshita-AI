      ...
      <main className="flex-1 p-6 flex items-center justify-center">
        <div className="text-center space-y-4 max-w-lg">
          ...
          <p className="text-slate-400">
            This workspace is dedicated to <strong>AffidavitWorkspace</strong> logic. It has its own state, history, and export functions.
          </p>
...
export default AffidavitWorkspace;
