...
export default function DocumentStudioViewer() {
  const { currentDocument, setCurrentDocument, setResponseMode, documentHistory, subscriptionMode } = useStore();
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      <html>
        ...
        <body>
          ${watermarkHtml}
          <div class="legal-document" style="position:relative; z-index:1;">
            ${content}
          </div>
        </body>
      </html>
      ...
      <div className="flex-1 overflow-auto p-8 flex justify-center bg-slate-950 scrollbar-thin">
        ...
        >
          ...
          <div 
            ...
            className="min-h-[220mm] outline-none text-justify whitespace-pre-wrap select-text selection:bg-indigo-200 relative z-10"
            onInput={handleInput}
            style={{ fontFamily }}
          >
